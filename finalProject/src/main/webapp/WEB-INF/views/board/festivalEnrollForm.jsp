        ...
        <div class="fes_wrap">
            ...
            <div class="fes_text">
                ...
                <div class="fes_input">
                    ...
                    <textarea name="boardContent" id="boardContent" cols="40" rows="10" style="margin-left: 41px; resize: none;" required></textarea>
                </div>
                <div class="fes_input">
                    <label for="startDate">축제 시작일</label>
                    <input type="text" id="startDate" name="startDate" placeholder="ex)2023-02-02" required>
                </div>
                <div class="fes_input">
                    <label for="endDate">축제 종료일</label>
                    <input type="text" id="endDate" name="endDate" placeholder="ex)2023-02-02" required>
                </div>
                <div class="fes_input">
                ...
                <div class="fes_input">
                    ...
                    <input type="text" id="fesMoney" name="fesMoney" style="margin-left: 47px;">
                </div>
                <div class="fes_input">
                    <label for="address">주소</label>
                    <input type="text" id="address" id="address" onclick="postcode();" style="margin-left: 79px;">
