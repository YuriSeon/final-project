...
/*         border:1px solid black; */
    ...
    #banner_2{
        width: 70%;
        background-image: linear-gradient(rgba(255,255,255,0.4),rgba(255,255,255,0.4)), url("/ws/resources/images/survey-background.jpg");
        ...
        <div id="wrap">
            <div id="mbtiBanner">
                ...
                <div id="banner_2">
                    ...
                    <img src="/ws/resources/images/survey-ticket.png" id="startBanner" alt="도착지" style="width: 555px; height:150px; margin-top: 35px;">
    			 ...
    			 success : function(mbti){
    				 ...
    				 switch(mbti){
	    				 case "ENFJ" : 
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ENFJ.png"); break;
	    				 case "ENFP" :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ENFP.png"); break;
	    				 case "ENTJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ENTJ.png"); break;
	    				 case "ISTP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ISTP.png"); break;
	    				 case "ENTP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ENTP.png"); break;
	    				 case "ESFJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ESFJ.png"); break;
	    				 case "ESFP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ESFP.png"); break;
	    				 case "ESTJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ESTJ.png"); break;
	    				 case "ESTP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ESTP.png"); break;
	    				 case "INFJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/INFJ.png"); break;
	    				 case "INFP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/INFP.png"); break;
	    				 case "INTJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/INTJ.png"); break;
	    				 case "INTP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/INTP.png"); break;
	    				 case "ISFJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ISFJ.png"); break;
	    				 case "ISFP"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ISFP.png"); break;
	    				 case "ISTJ"  :
	    					 ...
	    					 $("#resultImg").css("display","block").prop("src","/ws/resources/images/mbtiResult/ISTJ.png"); break;
    				 }; 
